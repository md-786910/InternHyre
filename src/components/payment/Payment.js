                ...
                <div className="row box-right">
                  ...
                  <div className="col-md-4">
                    ...
                    <p className="fw-bold mb-3">
                      <span className="fas fa-dollar-sign pe-1"></span>1254{" "}
                      <span className="textmuted">.50</span>{" "}
                    </p>{" "}
                    <p className="p-org">
                      <span className="fas fa-circle pe-2"></span>On drafts
                    </p>{" "}
                    <p className="fw-bold">
                      <span className="fas fa-dollar-sign pe-1"></span>00
                      <span className="textmuted">.00</span>
                    </p>{" "}
                  </div>{" "}
                </div>{" "}
              </div>{" "}
                ...
                <div className="box-right">
                  ...
                  <div className="d-flex pb-2">
                    ...
                    <p className="fw-bold h7">
                      <span className="textmuted">quickpay.to/</span>Publicnote
                    </p>{" "}
                  ...
                  <div className="bg-blue p-2">
                    <div className="h8 textmuted">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Laborum recusandae dolorem voluptas nemo, modi eos minus
                      nesciunt.
                    </div>
              ...
              <div className="col-12 px-0">
                ...
                <div className="box-right">
                  ...
                  <div className="d-flex mb-2">
                    ...
                    <p className="ms-auto bg btn btn-primary p-blue h8">
                      <span className="far fa-clone pe-2"></span>COPY PAYMENT
                      LINK{" "}
                    </p>{" "}
                  </div>{" "}
                  <div className="row">
              ...
              <div className="h8">
                ...
                <div className="row m-0 border mb-3">
                  ...
                  <div className="col-2 p-0 text-center h8 border-end">
                    ...
                    <span className="d-block border-bottom py-2">
                      <span className="fas fa-dollar-sign"></span>500
                    </span>{" "}
                    <span className="d-block py-2 ">
                      <span className="fas fa-dollar-sign"></span>400
                    </span>{" "}
                  </div>{" "}
                  <div className="col-2 p-0 text-center">
                    ...
                    <span className="d-block py-2 border-bottom">
                      <span className="fas fa-dollar-sign"></span>1000
                    </span>{" "}
                    <span className="d-block py-2">
                      <span className="fas fa-dollar-sign"></span>400
                    </span>{" "}
                ...
                <div className="h8 mb-5">
                  ...
                  <p className="textmuted">
                    Lorem ipsum dolor sit amet elit. Adipisci ea harum sed
                    quaerat tenetur{" "}
                  </p>{" "}
                </div>{" "}
              </div>{" "}
              <div className="">
                ...
                <div className="form">
                  ...
                  <div className="row">
                    ...
                    <p className="p-blue h8 fw-bold mb-3">
